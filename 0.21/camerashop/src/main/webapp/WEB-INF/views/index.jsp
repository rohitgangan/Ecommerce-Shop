            ...
            <a href="viewproduct--{{pr.productId}}--product"><img src="resources/images/{{pr.productId}}.jpg" alt=""></a>
              <div class="caption">
                ...
                <p>Product description here</p>
                 <span class="bottomleft"><a href="#" class="btn btn-info btn-lg" role="button">Buy Now</a> </span>
                 <span class="bottomright"> <a href="viewproduct--{{pr.productId}}--product" class="btn btn-default btn-lg" role="button">View Product</a></span>
            </div>
          </div>
        </div>
