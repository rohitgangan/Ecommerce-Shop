...
public class ProductDAOImplementation implements ProductDAO{
	...
	@SuppressWarnings("unchecked")
	public List<Product> listAllProduct(int productId) {
		// TODO Auto-generated method stub
		String query = "from Product WHERE productId= " + productId;
		List<Product> productList = this.sessionFactory.getCurrentSession().createQuery(query).getResultList();
		return productList;
	}
	...
	@SuppressWarnings("unchecked")
	public String productBySupplier() {
		// TODO Auto-generated method stub
		 Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
	      String username = authentication.getName(); //get logged in username
	     
	      String query = "from Product WHERE supplierName= '"+username+"'";
		List<ProductView> productJList = this.sessionFactory.getCurrentSession().createQuery(query).getResultList();
		Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create();
		String supplierProductGson = gson.toJson(productJList);
		return supplierProductGson;
	}
