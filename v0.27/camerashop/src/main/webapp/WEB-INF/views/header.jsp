...
<body style="background-color:#f1f1f1;" ng-app="getAllProductsDisplay" ng-controller="allProductDisplayController">
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse js-navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><c:if test="${pageContext.request.userPrincipal.name != null}">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<sec:authorize access="hasRole('ROLE_ADMIN')">
								...
								<li class="divider"></li>
								<li><a href="supplierActivation">Supplier Activation</a></li>
					...
					<sec:authorize access="hasRole('ROLE_USER')">
					<li><a href="my_cart"><i class="fa fa-shopping-cart" aria-hidden="true"></i> My cart</a> 
				</li></sec:authorize>
		...
		<div class="collapse navbar-collapse js-navbar-collapse">
			<ul class="nav navbar-nav">
				...
				<c:forEach items="${listCategory}" var="category">
					<li class="dropdown mega-dropdown"><a href="productdisplay?search=${category.categoryName}" class="dropdown-toggle" data-toggle="dropdown">${category.categoryName}<span
							class="caret"></span></a>
						...
						<ul class="dropdown-menu mega-dropdown-menu">
							<c:forEach items="${category.subCategory}" var="subCategory">
								<li class="col-sm-3">
									<ul>
										<li class="dropdown-header"><a href="productdisplay?search=${subCategory.subCategoryName}">${subCategory.subCategoryName}</a></li>
