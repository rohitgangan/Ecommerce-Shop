...
<div  class="col-sm-12 col-md-6 form-group">
<label style="font-size:20px">Sub Category Description</label>
...
<td><a href="editSubcategory-{{s.subCategoryId}}" class="btn btn-warning">edit</a> <a href="deleteSubcategory-{{s.subCategoryId}}" class="btn btn-danger">Delete</a>
</tr>
</table>
<script>
