...
public class UserHandler {
	...
	public UserDetails initFlow(){
		...
		public String saveOrUpdateUser(UserDetails userDetails, BillingAddress billingAddress, ShippingAddress shippingAddress,MessageContext messageContext){
			...
			email.setText("Youe account has been created successfully");
