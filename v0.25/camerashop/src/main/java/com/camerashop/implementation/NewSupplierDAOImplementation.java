...
public class NewSupplierDAOImplementation {
	...
	public SupplierActivation getById(int userId) {
		// TODO Auto-generated method stub
		String query = "from SupplierActivation WHERE userId= " + userId;
		List<SupplierActivation> supplierActivationList = sessionFactory.getCurrentSession().createQuery(query).getResultList();
