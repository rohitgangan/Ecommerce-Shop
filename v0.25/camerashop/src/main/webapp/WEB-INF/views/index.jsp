...
<div class="container-fluid" style="padding-top:160px;">
 ...
 <div class="container-fluid" id="tourpackages-carousel" style="padding-top:20px">
      ...
      <div class="row">
        ...
        <div class="col-xs-18 col-sm-6 col-md-3" ng-repeat="pv in productViewLists">
          <div class="thumbnail">
            <a href="viewproduct--{{pv.productId}}--product"><img src="resources/images/{{pv.productId}}.jpg" alt=""></a>
              <div class="caption">
                ...
                <span class="bottomleft"><a href="buy_now-{{pv.productId}}?userId=1" class="btn btn-info" role="button">Buy Now</a> </span>
