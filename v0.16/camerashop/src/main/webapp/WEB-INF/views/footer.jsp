  ...
  <div class="row">
      ...
      <div class="col-sm-3">
        <div class="foot-header">
          About Us <img src="http://200.27.156.170/ean_default/img/cocha/icon-cocha.png">
        </div>
    ...
    <div class="col-sm-3">
      <div class="foot-header"> Support <img src="http://200.27.156.170/ean_default/img/cocha/servicio-al-cliente-icon.png"></div>
      <div class="foot-links">
        ...
        <a href="http://cms.cocha.com/terminos-y-condiciones">Sell on Camshop</a>
    ...
    <div class="col-sm-3">
      <div class="foot-header">
       Payments Method<img src="http://200.27.156.170/ean_default/img/cocha/card-icon.png">
      </div>
      <div class="foot-links">
        <p>
