...
public class NewSupplierDAOImplementation {
	...
	public void addSupplierAddress(Supplier supplier){
		Session session = this.sessionFactory.getCurrentSession();
		supplier.setSupplierCompanyName(supplier.getSupplierCompanyName());
		supplier.setAddress1(supplier.getAddress1());
		supplier.setAddress2(supplier.getAddress2());
		supplier.setCity(supplier.getCity());
		supplier.setDistrict(supplier.getDistrict());
		supplier.setPinCode(supplier.getPinCode());
		supplier.setState(supplier.getState());
		supplier.setLandmark(supplier.getLandmark());
		supplier.setComapanyUrl(supplier.getComapanyUrl());
