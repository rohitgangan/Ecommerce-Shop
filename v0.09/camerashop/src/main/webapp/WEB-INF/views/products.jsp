...
<body style="margin-top: 100px">
	...
	<div class="container">
		<div class="row">
			...
			<form:form class="form-horizontal" method="POST" action="product"
				...
				<div class="col-sm-12 col-md-6 form-group">
					<label style="font-size: 20px" for="supplier">Select
						Supplier</label>
					<form:select path="supplier.supplierName" items="${listSupplier}"
				...
				<div class="col-sm-6 col-md-6 form-group">
					...
					<form:input path="productRent" class="form-control input-lg"
						id="prent" />
	...
	<div class="container" ng-app="getProduct"
		...
		<table class="table table-hover table-bordered table-striped">
			...
			<tr ng-repeat="p in products | orderBy:myOrderBy | filter:test">
				...
				<td>{{p.supplierId}}</td>
				<td><a href="editProdsuct-{{p.productId}}">Edit</a>| <a
