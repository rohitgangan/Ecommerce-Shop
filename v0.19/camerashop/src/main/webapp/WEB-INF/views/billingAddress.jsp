...
<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-6 col-md-6"><input name="_eventId_skip" type="submit" value="Skip" class="btn btn-primary btn-block btn-lg" tabindex="8"/></div> 
				<div class="col-xs-6 col-md-6">	<input name="_eventId_submit" type="submit" value="Submit" class="btn btn-success btn-block btn-lg"/><br /></div>
			</div>
</form:form>
</div></div></div>
